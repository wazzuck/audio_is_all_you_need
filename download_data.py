...
TEMP_DOWNLOAD_DIR = config.TEMP_DOWNLOAD_DIR # Import the temp directory

def download_urbansound8k(data_home=TEMP_DOWNLOAD_DIR): # Use TEMP_DOWNLOAD_DIR as default data_home
    ...
    if not os.path.exists(data_home):
        ...
        print(f"Created temporary directory: {data_home}")
...
if __name__ == "__main__":
    # Still check/create the final DATA_DIR if needed, 
    # though soundata might move files? Let's keep this for now.
